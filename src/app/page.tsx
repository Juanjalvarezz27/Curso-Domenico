...
import PremiumVideoPlayer from './components/home/PremiumVideoPlayer'; 
...
export default function LandingPage() {
 ...
 {/* HEADER / HERO SECTION */}
 <section className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 pt-24 md:pt-32 pb-16">
 ...
 <h1 className="font-outfit text-4xl sm:text-5xl md:text-5xl lg:text-7xl font-black tracking-tight mb-6 leading-[1.1] uppercase">
 ...
 <p className="text-lg md:text-xl text-gray-800 max-w-xl mx-auto md:mx-0 mb-10 leading-relaxed font-medium">
 Aprende a estructurar tu marca personal, profesionalizar tu contenido y convertir a tus seguidores en clientes.
 </p>
 
 <a href="#temario" className="group inline-flex bg-texto-principal text-superficie font-bold py-4 px-8 rounded-full hover:bg-gray-800 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 items-center justify-center gap-2">
 Ver Temario del Curso
 <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
 </a>
 </div>

 {/* VIDEO (Derecha en desktop, arriba en mobile) */}
 <div className="shrink-0">
 <div className="relative w-[260px] sm:w-[300px] lg:w-[340px] mx-auto rounded-[2rem] sm:rounded-[2.5rem] border-[6px] sm:border-8 border-gray-900 bg-gray-900 aspect-[9/16] shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden group transition-all duration-500 hover:shadow-[0_20px_60px_rgba(249,115,22,0.2)] hover:-translate-y-2">
 <PremiumVideoPlayer youtubeId="puTaWejgvCI" poster="/Profile1.png" />
 </div>
 </div>
