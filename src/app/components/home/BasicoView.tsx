...
export default function BasicoView() {
 ...
 <div className="h-0.5 bg-orange-500 w-8 rounded-full"></div>
 <span className="text-orange-400 font-black text-xs uppercase tracking-[0.2em]">Ejemplo Práctico</span>
 </div>
 ...
 Tu Perfil es tu <span className="text-orange-400">Landing Page</span>
 </h3>
 <p className="text-gray-400 font-medium text-sm sm:text-base leading-relaxed max-w-xl">
 Observa estos ejemplos reales. Un perfil optimizado retiene la atención, demuestra autoridad al instante y guía al usuario hacia la conversión.
 </p>
 </div>
 </div>
 ...
 <Sparkles size={16} className="text-orange-400" /> Checklist de Optimización
 </h4>
 <ul className="space-y-3">
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-orange-400 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-300 font-medium"><strong className="text-white">Foto Clara y Limpia:</strong> Usa fondos sólidos o colores de tu marca. El rostro debe verse iluminado y transmitir confianza.</span>
 </li>
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-orange-400 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-300 font-medium"><strong className="text-white">Bio Estructurada:</strong> Escribe a quién ayudas y cómo lo haces. Termina siempre con un llamado a la acción (CTA) directo hacia tu enlace.</span>
 </li>
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-orange-400 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-300 font-medium"><strong className="text-white">Historias Estratégicas:</strong> Diseña portadas limpias para tus destacadas (Servicios, Testimonios, Sobre Mí). Serán tus vendedoras 24/7.</span>
 </li>
 </ul>
 </div>
 </div>
 ...
 <span className="text-pink-500 font-black text-xs uppercase tracking-[0.2em]">Ejemplo Práctico</span>
 </div>

 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-8 mb-8">
 <div className="flex-1">
 <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 tracking-tight leading-tight mb-3">
 Análisis de <span className="text-pink-500">Reels Virales</span>
 </h3>
 <p className="text-gray-500 font-medium text-sm sm:text-base leading-relaxed max-w-xl">
 Observa estos ejemplos reales que lograron captar la atención de millones. Analiza el gancho, la retención y el llamado a la acción.
 </p>
 </div>
 </div>
 ...
 <Sparkles size={16} className="text-pink-500" /> Fórmula de Viralidad
 </h4>
 <ul className="space-y-3">
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-pink-500 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-600 font-medium"><strong className="text-gray-900">El Gancho (3 Segundos):</strong> Rompe el patrón visual o usa una frase inesperada desde el primer instante para detener el scroll.</span>
 </li>
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-pink-500 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-600 font-medium"><strong className="text-gray-900">Retención Dinámica:</strong> Mantén un ritmo rápido. Cambia de plano, añade textos en pantalla para apoyar lo que dices y elimina espacios en blanco.</span>
 </li>
 <li className="flex items-start gap-3">
 <CheckCircle2 size={16} className="text-pink-500 shrink-0 mt-0.5" />
 <span className="text-sm text-gray-600 font-medium"><strong className="text-gray-900">Cierre con Acción:</strong> Diles exactamente qué hacer al final. Un claro "Guarda este video", "Sígueme para más" o "Comenta para info".</span>
 </li>
 </ul>
 </div>
 </div>
